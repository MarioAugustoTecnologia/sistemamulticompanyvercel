...
const ComprasMes = () => {
      ...
      var table = compradata.filter(item => item.mes.toLowerCase().includes(buscarap))
    ...
    function somar(){
       ...
       let valores = [];    
        ...
        return parseFloat(previous_value) + parseFloat(current_value);    
          ...
          const cadobj = { nome, custo, total, data_cad, mes, valorpag, troco }   
    ...
    <div className="row flex-nowrap">
       ...
       <div className="col p-0 m-0"  style={{fontFamily:'arial'}} >
           ...
           <div className="px-5 mt-5"> 
               <div className="mb3">
                  <label htmlFor="Mes" className="Mes" style={{fontFamily: 'arial', fontSize:'22px'}}>Busca por Mês:</label><br />
                  ...
                  <Link onClick={somar} className="btn" style={{color: 'white', backgroundColor:'gray', margin: '0 0px', fontSize: '18px', fontFamily:'arial'}}>Total Compras:</Link> 
                </div><br />                 
            
                      <h4 ><strong style={{textAlign: 'center', color: 'Red', fontSize: '25px', margin:'0 1080px'}}>Compras:</strong></h4>                         
                     <br />
                    <div className="mt-3">
